...
import cbpdbms.ParsingException;
...
public class JoinOptimizerTest extends SimpleDbTestBase {
	 ...
	 */
	@Test
	public void estimateJoinCostTest() throws ParsingException, DbException, TransactionAbortedException {
		...
		jo = new JoinOptimizer(
				Parser.generateLogicalPlan(tid,
	 ...
	 */
	@Test
	public void estimateJoinCardinality() throws ParsingException, DbException, TransactionAbortedException {
		TransactionId tid = new TransactionId();
		...
		cardinality = j.estimateJoinCardinality(
				new LogicalJoinNode(tableName1, tableName2, Integer.toString(3), Integer.toString(4),
						Predicate.Op.EQUALS),
	...
	public void orderJoinsTest() throws ParsingException, IOException, DbException, TransactionAbortedException {
		...
		// outermost table.
		Assert.assertFalse(
				result.get(2).t2 == "hobbies" && (result.get(0).t1 == "hobbies" || result.get(0).t2 == "hobbies"));
	}
