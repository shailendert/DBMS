...
public class TableStatsTest extends SimpleDbTestBase {
	 ...
	 * HeapFile This test checks that the estimateScanCost is: +linear in
	 * numPages when IO_COST is constant +linear in IO_COST when numPages is
	 * constant +quadratic when IO_COST and numPages increase linearly.
	 */
	@Test
	...
	public void estimateSelectivityTest() {
		final int maxCellVal = 32; // Tuple values are randomized between 0 and
		// this number
