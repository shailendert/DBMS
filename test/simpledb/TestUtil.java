...
import cbpdbms.DbFile;
import cbpdbms.DbFileIterator;
import cbpdbms.DbIterator;
import cbpdbms.Field;
import cbpdbms.HeapFile;
import cbpdbms.IntField;
import cbpdbms.Page;
import cbpdbms.PageId;
import cbpdbms.Permissions;
import cbpdbms.StringField;
...
public class TestUtil {
	...
	static class LockGrabber extends Thread {
		...
		public boolean acquired() {
			System.out.println("testThreadId:" + Thread.currentThread().getId());
			synchronized (alock) {
				System.out.println("return " + acquired);
				return acquired;
			}
		}
